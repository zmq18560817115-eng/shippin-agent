    ...
    return {
        ...
        "sections": [
            ...
            },
            {
                ...
                "role": "痛点",
                "timing": "3-6s",
                "voiceover_zh": "奶液变冷和等待，会让睡前准备更困难。",
                "selling_points": [],
            },
            {
                "number": 3,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (lambda p: p["sections"][0].pop("voiceover_zh"), "/sections/0"),
        ...
        (lambda p: p["sections"][0].__setitem__("voiceover_zh", "This is the best guaranteed pain-free warmer."), "/sections/0/voiceover_zh"),
    ],
)
